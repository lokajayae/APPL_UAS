...
public class Hotel
{
        ...
        switch(rtype)
        {
            case 1:
                amount+=4000;
                    ...
                    System.out.println("-------------------------");
                    for(Food obb : hotel_ob.luxury_doubleroom[rn].getFood())
                    {
                        amount += obb.getPrice();
            ...
            case 2:amount+=3000;
                    ...
                    System.out.println("===============");
                     System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
                    for(Food obb:hotel_ob.deluxe_doubleroom[rn].getFood())
                    {
                        amount+=obb.getPrice();
                        String format = "%-10s%-10s%-10s%n";
                        System.out.printf(format,list[obb.getItemno()-1], obb.getQuantity(),obb.getPrice() );
            ...
            case 3:amount+=2200;
                    ...
                    System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
                    for(Food obb:hotel_ob.luxury_singleroom[rn].getFood())
                    {
                        amount+=obb.getPrice();
                        String format = "%-10s%-10s%-10s%n";
                        System.out.printf(format,list[obb.getItemno()-1], obb.getQuantity(),obb.getPrice() );
            ...
            case 4:amount+=1200;
                    ...
                    System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
                    for(Food obb : hotel_ob.deluxe_singleroom[rn].getFood())
                    {
                        amount+=obb.getPrice();
                        String format = "%-10s%-10s%-10s%n";
                        System.out.printf(format,list[obb.getItemno()-1], obb.getQuantity(),obb.getPrice() );
    ...
    static void deallocate(int rn,int rtype)
    {
        ...
        switch (rtype) {
            case 1:               
                if(hotel_ob.luxury_doubleroom[rn]!=null)
                    System.out.println("Room used by "+hotel_ob.luxury_doubleroom[rn].getName());                
                else 
                {    
            ...
            case 2:
                if(hotel_ob.deluxe_doubleroom[rn]!=null)
                    System.out.println("Room used by "+hotel_ob.deluxe_doubleroom[rn].getName());                
                else 
                {    
                    System.out.println("Empty Already");
                        return;
            ...
            case 3:
                if(hotel_ob.luxury_singleroom[rn]!=null)
                    System.out.println("Room used by "+hotel_ob.luxury_singleroom[rn].getName());                
                else 
                 {    
                    System.out.println("Empty Already");
                        return;
            ...
            case 4:
                if(hotel_ob.deluxe_singleroom[rn]!=null)
                    System.out.println("Room used by "+hotel_ob.deluxe_singleroom[rn].getName());                
                else 
                 {    
                    System.out.println("Empty Already");
                        return;
    ...
    static void order(int rn,int rtype)
    {
        ...
        do
        {
            ...
            q=sc.nextInt();
              ...
              switch(rtype){
            case 1: hotel_ob.luxury_doubleroom[rn].getFood().add(new Food(i,q));
                break;
            case 2: hotel_ob.deluxe_doubleroom[rn].getFood().add(new Food(i,q));
                break;
            case 3: hotel_ob.luxury_singleroom[rn].getFood().add(new Food(i,q));
                break;
            case 4: hotel_ob.deluxe_singleroom[rn].getFood().add(new Food(i,q));
                break;                                                 
        }
